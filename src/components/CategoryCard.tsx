...
export const CategoryCard: React.FC<CategoryCardProps> = ({ category, index }) => {
  ...
  return (
    <Link 
      ...
      className={`relative group h-28 sm:h-36 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-primary/20 ${bgColor}`}
    >
