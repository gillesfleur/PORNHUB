...
import { ArrowUpDown, Zap, TrendingUp, Calendar, Star, SlidersHorizontal } from 'lucide-react';
...
export const TopRatedPage: React.FC = () => {
  ...
  return (
    ...
    >
      <SEO 
        title="Vidéos les mieux notées" 
        description="Découvrez les vidéos les mieux notées par la communauté sur VibeTube." 
      />
