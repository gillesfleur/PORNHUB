...
type SortOption = 'views' | 'likes' | 'recent';
...
export const PopularPage: React.FC = () => {
  ...
  const filteredVideos = useMemo(() => {
    ...
    // Simulated Period Filter (In a real app, we'd filter by date)
    // For the prototype, we just keep all videos but we could shuffle or slice for effect
  ...
  return (
    ...
    >
      <SEO 
        ...
        description="Regardez les vidéos les plus populaires et les plus vues sur VibeTube." 
      />
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-black text-main uppercase tracking-tighter mb-4 flex items-center gap-3">
            <span className="text-primary">🔥</span> Vidéos les plus populaires
          </h1>
          <AdBanner size="leaderboard" position="popular-top" className="mb-8" />
        </div>
            ...
            <AnimatePresence mode="wait">
              {paginatedVideos.length > 0 ? (
                    ...
                    <React.Fragment key={video.id}>
                      ...
                      {index === 3 && (
                        <div className="sm:col-span-2 lg:col-span-1">
                          <AdBanner size="native" position="popular-grid" />
                        </div>
                      )}
                    </React.Fragment>
                  ))}
                ...
                <div className="text-center py-20 bg-surface/30 rounded-3xl border border-dashed border-muted/30">
                  ...
                  <h3 className="text-xl font-black text-main mb-2 uppercase tracking-tighter">Aucune vidéo populaire</h3>
          ...
          <aside className="hidden lg:block w-80 shrink-0 space-y-8">
            <div className="sticky top-24 space-y-8">
              <div className="bg-surface/30 p-6 rounded-3xl border border-muted/10">
                ...
                <AdBanner size="rectangle" position="popular-sidebar" />
              </div>
